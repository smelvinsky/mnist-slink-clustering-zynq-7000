...
HD_PWD='C:/Users/Pulpecik/distance_zybo2/distance_zybo2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_zybo2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_zybo2_wrapper.tcl -notrace
