...
HD_PWD='C:/Users/Pulpecik/distance_zybo2/distance_zybo2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_zybo2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_zybo2_wrapper.tcl
